    ...
    $.fancyConfirm = function (opts) {
        ...
        $.fancybox.open({
                            ...
                            src :
                                ...
                                '<a href="#" class="' + opts.noButtonClass + ' button button-confirm button-confirm__no" data-value="0" data-fancybox-close>' + opts.noButton + '</a>' +
                                '<button data-value="1" data-fancybox-close class="' + opts.okButtonClass + ' button button-confirm button-confirm__yes">' + opts.okButton + '</button>' +
                                '</div>' +
                                '</div>',
