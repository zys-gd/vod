...
namespace Carriers\TelekomDEDimoco\Identification;
...
/**
 * Class TelekomDEDimocoWifiIdentificationHandler
 */
class TelekomDEDimocoWifiIdentificationHandler implements WifiIdentificationHandlerInterface
{
    /**
     * @var UserRepository
     */
    ...
    {
        return $carrier->getBillingCarrierId() === ID::TELEKOM_DE_DIMOCO;
    }
