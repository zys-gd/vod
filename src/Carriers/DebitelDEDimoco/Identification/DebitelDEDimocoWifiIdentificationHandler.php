...
namespace Carriers\DebitelDEDimoco\Identification;
...
/**
 * Class DebitelDEDimocoWifiIdentificationHandler
 */
class DebitelDEDimocoWifiIdentificationHandler implements WifiIdentificationHandlerInterface
{
    /**
     * @var UserRepository
     */
    ...
    {
        return $carrier->getBillingCarrierId() === ID::DEBITEL_DE_DIMOCO;
    }
