...
class IDTextsHandler implements CarrierSMSHandlerInterface
{
    ...
    {
        return [
            'subscribe'    => "Terima kasih telah berlangganan layanan 100% Sport dengan tarif _currency_ _int_price_/3 hari selama 60 hari. Stop: UNREG 100SPORT. CS: 0895355290340",
            ...
            'notify_renew' => 'Nikmati video dan berita 100% Sport dari DOT! Download kontennya di _autologin_url_, hanya dengan _currency__int_price_/3 hr. Stop:UNREG 100SPORT. CS: 0895355290340'
        ];
    }
}