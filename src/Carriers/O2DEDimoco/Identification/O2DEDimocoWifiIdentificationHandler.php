...
namespace Carriers\O2DEDimoco\Identification;
...
/**
 * Class O2DEDimocoWifiIdentificationHandler
 */
class O2DEDimocoWifiIdentificationHandler implements WifiIdentificationHandlerInterface
{
    /**
     * @var UserRepository
     */
    ...
    {
        return $carrier->getBillingCarrierId() === ID::O2_DE_DIMOCO;
    }
