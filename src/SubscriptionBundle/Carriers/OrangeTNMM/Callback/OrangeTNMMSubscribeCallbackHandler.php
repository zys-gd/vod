...
namespace SubscriptionBundle\Carriers\OrangeTNMM\Callback;
 ...
 * Time: 11:18
 */
class OrangeTNMMSubscribeCallbackHandler implements CarrierCallbackHandlerInterface, HasCustomConversionTrackingRules, HasCustomFlow
{
    /**
    ...
    {
        return $carrierId == ID::ORANGE_TUNISIA_MM;
    }
    ...
    {
        $this->commonFlowHandler->process($request, ID::ORANGE_TUNISIA_MM, $type);
    }
}