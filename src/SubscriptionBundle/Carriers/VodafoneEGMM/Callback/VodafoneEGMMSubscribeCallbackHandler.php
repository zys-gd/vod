...
namespace SubscriptionBundle\Carriers\VodafoneEGMM\Callback;
 ...
 * Time: 11:18
 */
class VodafoneEGMMSubscribeCallbackHandler implements CarrierCallbackHandlerInterface, HasCustomConversionTrackingRules, HasCustomFlow
{
    /**
    ...
    {
        return $carrierId == ID::VODAFONE_EGYPT_MM;
    }
    ...
    {
        $this->commonFlowHandler->process($request, ID::VODAFONE_EGYPT_MM, $type);
    }
}