...
<html>
  <head>
    <title>DeviceAtlas Content Adaptation example | Mobile Device</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link type="text/css" rel="stylesheet" href="css/mobile.css" media="all" />
...
<!--
 ...
 -->    
    ...
    if ($properties->contains('js.supportBasicJavaScript', true)) {
        echo '<script>';
  ...
  <body <?php echo "style='max-width:".$properties->contains('displayWidth', '1024')."px'"; ?>>
...
<!--
 ...
 -->    
    <?php
    $displayHeight       = $properties->containsKey('displayHeight')?    $properties->get('displayHeight')->asInteger():   1;
    $devicePixelRatio    = $properties->containsKey('devicePixelRatio')? $properties->get('devicePixelRatio')->asString(): 1;
...
<!--
 ...
 -->    
    ...
    <h1>Mobile Device Experience</h1>
    <div id="contents">

      <div id="description" class="row">
        <p>
          This is the layout of our sample site intended for mobile device
          experience.
        </p>
      </div>
      ...
      <div id="image-container">
        <p>
          ...
          type of device. We can even optimize the page further and use property
          values such as "displayWidth", "displayHeight", "usableDisplayWidth" and
          "usableDisplayHeight" to provide the optimal photo.
        </p>
        <p>
          As we already know a mobile is viewing this page it seems showing the smallest
          sized photo is a safe bet, but with the new devices being able to display
          high resolutions it may not be a pleasant experience for the user so lets
          use the properties...
        </p>
        <?php
          $width = $properties->containsKey('usableDisplayWidth')?
              $properties->get('usableDisplayWidth')->asInteger(): 0;
          $imageSize = 'small';
          if ($width > 900) {
              $imageSize = 'large';
          } elseif ($width > 500) {
        ...
        ?>
        <img src="images/homa-<?php echo $imageSize; ?>.jpg" />
      </div>
      ...
      <div class="row">
        ...
        <p>
          ...
          wrapped around the data and sent back to the user.
        </p>
        <p>
        ...
        <table>
          <?php
            ...
            foreach ($properties as $name => $property) {
                ...
                if ($property->getDataTypeId() === Mobi_Mtld_DA_DataType::BOOLEAN) {
      ...
      <div class="row">
        ...
        <?php
          ...
          if ($properties->contains('flashCapable', true)) {
