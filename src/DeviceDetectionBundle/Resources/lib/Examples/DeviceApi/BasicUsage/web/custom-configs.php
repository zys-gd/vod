 ...
 * This example shows how to change the default DeviceApiWeb configs.
 *
...
// if you do not need certain property sets you can exclude them to make the detections faster
// you can change the config settings at any point, before or after passing the Config instance to the API constructor
