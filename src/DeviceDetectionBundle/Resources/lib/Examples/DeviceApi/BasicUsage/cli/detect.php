...
try {
    ...
    // you can get the full set of device property names if you need to see them
    displayPropertyNames($deviceApi);
...
/**
 * Displaying property names
 * demonstrates the usage of "getPropertyNames()" method
 */
function displayPropertyNames($deviceApi) {

    print "-------------------------------------------------------------\n";
    print "Property names:\n";

    foreach ($deviceApi->getPropertyNames() as $propertyNames) {
        print $propertyNames->getName().' ('.$propertyNames->getDataType().")\n";
    }
}
