...
final class Version20190710114232 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("UPDATE translations SET translation = 'يمكنك إلغاء اشتراكك في أي وقت من قسم \"حسابي\" أو عن طريق إرسال UNSUB 100 إلى 5030' WHERE `key` = 'annotation_block.text.3' AND carrier_id = '7c8385df-8d56-464a-98ff-66c55a7a5741'");
        $this->addSql("UPDATE translations SET translation = 'يمكنك إلغاء اشتراكك في أي وقت من قسم \"\"حسابي\"\" أو عن طريق إرسال UNSUB 100 إلى 6699' WHERE `key` = 'annotation_block.text.3' AND carrier_id = '99a362ea-72cd-45d5-bbcc-18f16b8451ed'");
