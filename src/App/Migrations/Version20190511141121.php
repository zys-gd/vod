 ...
 */
final class Version20190511141121 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE affiliates DROP unique_flow, DROP unique_parameter');
        $this->addSql('ALTER TABLE black_list DROP duration, DROP ban_start, DROP ban_end');
    }
}
