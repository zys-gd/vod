...
final class Version20191112111402 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        $this->addSql("
            ...
            INSERT INTO translations (`uuid`,`key`,`translation`,`language_id`,`carrier_id`) VALUES ('a8d1a389-52f8-443a-bfa0-213583e94b41','wrong_cookie_page.text','Oups, apparemment, l''acceptation des cookies est désactivée dans les paramètres de votre navigateur.Autorisez-le et profitez de notre service: Paramètres> Paramètres du site> Autoriser. Pour revenir en arrière, veuillez cliquer %backLink%',(SELECT `uuid` FROM `languages` WHERE `uuid` = '5179f269-ebd4-11e8-95c4-02bb250f0f22'),(SELECT `uuid` FROM `carriers` WHERE `uuid` = ''));
            
            INSERT INTO translations (`uuid`,`key`,`translation`,`language_id`,`carrier_id`) VALUES ('af60cc81-8565-402f-b6d6-d6c7be1dc3ed','wrong_cookie_page.backlink_title','sini',(SELECT `uuid` FROM `languages` WHERE `uuid` = '5179f466-ebd4-11e8-95c4-02bb250f0f22'),(SELECT `uuid` FROM `carriers` WHERE `uuid` = ''));
            INSERT INTO translations (`uuid`,`key`,`translation`,`language_id`,`carrier_id`) VALUES ('f9d6a7d9-7f62-4742-a0af-1cda32e096c2','wrong_cookie_page.text','Ups, tampaknya penerimaan cookie dimatikan dalam pengaturan browser Anda.Tolong, izinkan, dan nikmati layanan kami: Pengaturan> Pengaturan situs> Izinkan cookie. Untuk kembali, silakan klik di %backLink%',(SELECT `uuid` FROM `languages` WHERE `uuid` = '5179f466-ebd4-11e8-95c4-02bb250f0f22'),(SELECT `uuid` FROM `carriers` WHERE `uuid` = ''));
