...
final class Version20191112111402 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        $this->addSql("
            ...
            INSERT INTO translations (`uuid`,`key`,`translation`,`language_id`,`carrier_id`) VALUES ('f9d6a7d9-7f62-4742-a0af-1cda32e096c2','wrong_cookie_page.text','Ups, tampaknya penerimaan cookie dimatikan dalam pengaturan browser Anda.Tolong, izinkan, dan nikmati layanan kami: Pengaturan> Privasi> Izinkan cookie. Untuk kembali, silakan klik di %backLink%',(SELECT `uuid` FROM `languages` WHERE `uuid` = '5179f466-ebd4-11e8-95c4-02bb250f0f22'),(SELECT `uuid` FROM `carriers` WHERE `uuid` = ''));
