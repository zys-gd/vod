...
final class Version20190507142021 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("INSERT INTO translations (uuid, language_id, carrier_id, `key`, translation) VALUES ('8eaee52e-72af-4f7b-b089-bb474064a252', '5179f17c-ebd4-11e8-95c4-02bb250f0f22', '99a362ea-72cd-45d5-bbcc-18f16b8451ed', 'buttons.unsubscribe', 'Unsubscribe from 100% sport')");
        $this->addSql("INSERT INTO translations (uuid, language_id, carrier_id, `key`, translation) VALUES ('39be4544-159c-479e-8d87-fs5d6f7a9e8d', '5179f17c-ebd4-11e8-95c4-02bb250f0f22', '99a362ea-72cd-45d5-bbcc-18f16b8451ed', 'annotation_block.text.3', 'You can cancel your subscription anytime from My Account section or by sending UNSUB SPORT to 6699')");
        ...
        $this->addSql("INSERT INTO translations (uuid, language_id, carrier_id, `key`, translation) VALUES ('8ea5dd5e-72af-4f7b-b089-bb4740s7a252', '5179f17c-ebd4-11e8-95c4-02bb250f0f22', '7c8385df-8d56-464a-98ff-66c55a7a5741', 'buttons.unsubscribe', 'Unsubscribe from 100% sport')");
        ...
        $this->addSql("INSERT INTO translations (uuid, language_id, carrier_id, `key`, translation) VALUES ('39s5d6f9-159c-479e-8d87-fcf4757a9e8d', '5179f17c-ebd4-11e8-95c4-02bb250f0f22', '7c8385df-8d56-464a-98ff-66c55a7a5741', 'annotation_block.text.3', 'You can cancel your subscription anytime from My Account section or by sending UNSUB SPORT to 5030')");
    }
