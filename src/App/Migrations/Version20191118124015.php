 ...
 */
final class Version20191118124015 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO `carriers` (`uuid`, `default_language_id`, `billing_carrier_id`, `operator_id`, `name`, `country_code`, `isp`, `published`, `trial_initializer`, `trial_period`, `subscription_period`, `is_campaigns_on_pause`, `subscribe_attempts`, `number_of_allowed_subscriptions_by_constraint`, `redirect_url`, `flush_date`, `is_cap_alert_dispatch`, `is_clickable_sub_image`, `is_one_click_flow`) VALUES
('3de06e41-f889-4f95-aac3-ebd31d9d7dg4', NULL, 2327, 21, 'Beeline KZ', 'KZ', 'Kar-Tel LLC|Kar-Tel LLC|Kar-Tel LLC', 1, 'store', 1, 1, 0, 5, 0, 'https://www.google.com/', NULL, 0, 1, 0);");
...
('27261246-9034-438f-ba37-274dd6d5d4d3', '510415b8-ebd4-11e8-95c4-02bb250f0f22', '3de06e41-f889-4f95-aac3-ebd31d9d7dg4', 1, 'Beeline KZ', '', 0, '50.00', 'KZT', '', 2, 1, 0, 1, 0, '02:00:00', '21:00:00', '', '', '', 2, 61, 61, 0, 0, 1, 0, 0, 0, 0, '2017-12-07 13:55:10', '2018-03-29 11:56:06', 0, 0);
");
    }
