...
final class Version20190806125816 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("INSERT INTO translations (uuid, language_id, carrier_id, `key`, translation) VALUES ('e31516b6-9bb2-40f9-98a2-b076005793f5', '5179f17c-ebd4-11e8-95c4-02bb250f0f22', null, 'messages.subscription_popup.confirmation_text', 'Hi %phone%, you will be subscribed to service 100% sport with rate %currency% %price%/%period%');");

        $this->addSql("INSERT INTO translations (uuid, language_id, carrier_id, `key`, translation) VALUES ('ae0414be-b2c8-49d8-8a07-8809ce517910', '5179f17c-ebd4-11e8-95c4-02bb250f0f22', null, 'messages.subscription_popup.confirmation_title', '');");
    }
